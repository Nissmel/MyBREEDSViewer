NOTE: This program is not really OOP and more of spaghetti code. The only reason why is lack of time. For more Java convention and OOP programing code sees my other projects.         
